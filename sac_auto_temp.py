...
def update(data, q1, q1_optim, q2, q2_optim, q1_target, q2_target, policy, policy_optim, \
           alpha, target_entropy, log_alpha, alpha_optimizer, writer, total_step):
    writer.add_scalar('value/alpha', alpha, total_step)
    ...
    alpha = log_alpha.exp()
    writer.add_scalar('loss/alpha', alpha_loss, total_step)
...
def main():
    ...
    alpha_optimizer = optim.Adam([log_alpha], lr=0.0003)
    ...
    for episode_number in range(max_episode):
        ...
        while not done:
            ...
            if (total_step >= minimum_buffer_size and total_step%update_every == 0):                
                ...
                alpha = update(batch, q1, q1_optim, q2, q2_optim, q1_target, q2_target, policy, policy_optim, \
                       alpha, target_entropy, log_alpha, alpha_optimizer, writer, total_step)
